...
import { CategoriasService } from '../servicios-backend/categoria-producto/categoria-producto.service';
...
export class Tab2Page {
  ...
  constructor(private categoriaProductoService: CategoriasService) {
